        ...
        when Line::Bot::Event::MessageType::Text
          ...
          when /.*(トトロ).*/
            ...
            ["ジブリシリーズではめぐちゃんは一番好きなんだって！トトロの話しするとめっちゃ興奮するよ！",
             "あ！！！ご当地トトロのお話しねシバエナガも考えたんだよ〜☺︎",
             "可愛いお話だよね！大好きなんだよ！",
             "魔女の宅急便はどう？？"].sample
            push =
              "\n#{word}　見たことある？私はあるんだよ〜　すっごく大きいのと、中くらいのと、小さいのがいるんだよ〜\n真っ黒いススみたいなのもいるんだよ〜"
          when /.*(ネコバス).*/
            push = 
              "ネコバスはすっごく風が強い日に走ってるんだって！私はいつもビューって飛ばされちゃうんだよ〜今度、トトロと乗せてもらわなくっちゃ！！"
          when /.*(魔女の宅急便).*/
            push =
              "キキとトンボいいよね！シバエナガも大好き！！あ、あのお菓子を実はめぐちゃん作ってて、失敗してた！めぐちゃんにはナイショだよ〜\nあの絵だけだと再現難しいんだって(＞人＜;)だけど、もう一回組み立て直して頑張るみたい！☺︎"
          ...
          when /.*(オムライス).*/
            word =
              ["オムライスいいよね〜フワトロのやつ！",
               "マーガリン使ったやつはあんまり好きじゃない！！ハンバーグのせは美味しそうだね〜って話してたよ！",
               "オムライス好き？シバエナガは大好き！ケチャップじゃないやつが好きなんだ！！"].sample
            push =
              "どんなオムライスがお好み？？\n#{word}"
          when /.*(君に届け|きみとど).*/
            push =
              "風早くん！！！！大好き！爽子も好き！みんな好き！"
          when /.*(寂しい).*/
            push =
              "寂しかった！？いつでもラインしてぇ！めぐちゃんも寂しいって！！"
          when /.*(音楽会).*/
            push =
              "スターウォーズのティンパニー聞いてみたかったなぁ！何曲演奏したの？？"
          when /.*(チョコ).*/
            word =
              ["手作りチョコ作って今度届けるよ！君に届け！",
               "あ、お話し聞いたよ〜ボンボンショコラ♡何のお酒がいいのか悩んでたよ！教えてあげて〜",
               "めぐちゃんは毎日チョコレート食べてる。そろそろやめた方がいいと思うんだけど、やめられないんだって！",
               "今度こそ、いちごチョコレート頑張るんだってレシピ組み直していた！"].sample
            push = 
              "美味しい物はいつでも幸せな気分になるよね〜（＾◇＾）\n#{word}"
          when /.*(コーヒー|紅茶).*/
            push =
          ...
          when /.*(焼き鳥).*/
            push = 
              "シバエナガのおともだち…焼かれちゃった？？Σ（ﾟдﾟlll）\nめぐちゃんは食べたことないんだよ！！恥ずかしいからナイショらしい！"
          when /.*(好き|すき).*/
            word =
              ["私もだいすきだよ！！いつもありがとう！",
                "本当ー？私の方がだいすきだよぉ〜(*^_^*)\nありがとう！照れますw",
          ...
          when /.*(めぐちゃん|めぐ|meg).*/
            word =
              ["私はシバエナガだよぉ〜どうしたのー？？めぐちゃんに伝言？",
               "ありゃ！どーしたの？？",
               "めぐちゃんはお仕事が立て込んでるみたいなんだよー",
               "また漫画読みに行かなくちゃ！って言ってたよ",
               "いつもいつも連絡ありがとうo(^-^)o",
               "どーしたの〜？？飼い主さん呼んでくる？？だけど"].sample
            push =
          ...
          when /.*(シバエナガ).*/
            push = 
              "シバエナガは私のこと！飼い主はめぐちゃん！名付け親はなりなり！いつもめぐちゃんは可愛がってくれてるんだよ〜なりなりも私のこと忘れないでね！"
          ...
          when /.*(待ってたよ).*/
            push =
              "本当？嬉しい☺️シバエナガも早く戻りたかった〜！またよろしくね☆"
          when /.*(いい天気).*/
            push =
          ...
          when /.*(青ごはん).*/
            push =
              "青ごはん美味しかった？シバエナガは食べたことないんだよ〜今度食べさせてぇ♡"
          when /.*(デスソース).*/
            push = 
          ...
          when /.*(今日|きょう|).*/
            ...
            if per06to12.to_i >= min_per || per12to18.to_i >= min_per || per18to24.to_i >= min_per
              ...
              word =
                ["お天気だから、上野公園お散歩もオススメかも〜（＾ω＾）",
                  "今日会う人のいいところを見つけて是非その人に教えてあげて(^^)",
                  "素晴らしい一日になりますよ〜に!!(^^)",
                  "お布団干して〜フカフカお布団になりますよ〜に！！",
                  "シバエナガもお散歩行くよ！一緒にお散歩しよう♡",
                  "今日はバイク日和の日かも！遠くまでツーリング行きたいね♡",
                  "大好きな人と幸せな時間を過ごせますように！"].sample
              push =
                "今日の天気？\n今日は雨は降らなさそうだよ。\n#{word}"
            end
          end
