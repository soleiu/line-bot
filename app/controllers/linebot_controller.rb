    ...
    events.each { |event|
      ...
      when Line::Bot::Event::Message
        ...
        when Line::Bot::Event::MessageType::Text
          ...
          when /.*(ヒトカゲ).*/
            push =
              "直立した恐竜の様な身体と尻尾の先端に常に燃えている炎が特徴。尻尾の炎は生まれた時からあり、この炎が消えると死んでしまうの。元気のバロメーターなんだよ！\n炎は、気分によっても変化するの。楽しい時と怒ってる時で違うんだって〜知ってた？？\n育てるなら、いじっぱり、控えめ、臆病の中から育てると強くなるかも！！\nLv.16でリザードにLv.36でリザードンに進化するよ〜！リザードンになると　ほのお　ひこう　になるよ！"
          when /.*(カビゴン).*/
            push =
              "いねむりポケモン。HP種族値が高く、弱点がかくとう技のみで耐久性が高い。防衛ではトップクラス！ノーマルタイプ。1日に食べ物を400kg食べるみたい。食べると寝ちゃうんだって！可愛いね〜♡カビゴンのモデルになった人がいるらしいよ！！"
